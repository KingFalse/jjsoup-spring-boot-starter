...
public class AspectControllerLoginInfo {
    ...
    @Around(value = "@within(org.springframework.stereotype.Controller) || @within(org.springframework.web.bind.annotation.RestController) && args(*,*,..)", argNames = "joinPoint")
    public Object Around(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        for (int i = 0; i < parameters.length; i++) {
            ...
            LoginInfoKey annotation = parameter.getAnnotation(LoginInfoKey.class);
            if (annotation != null) {
                loginInfoKeyIndex = i;
            }
